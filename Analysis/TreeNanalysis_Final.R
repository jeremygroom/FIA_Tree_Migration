...
write_csv(sumtaylor,paste0(RES, "sumtaylor_num_change_", SELECT.VAR, "_", RESP.TIMING, ".csv"))
...
r1 <- fia.dataprep.fcn(paste0(RES, "sumtaylor_num_change_", SELECT.VAR, "_", RESP.TIMING,  ".csv")) %>% filter(spp.codes != 768) %>%
